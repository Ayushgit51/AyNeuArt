...
class ImageFolderDataset(Dataset):
    def __init__(self, root, transform=None):
        ...
        self.filter = [p for p in self.files if p.endswith(('.png', '.jpg', '.jpeg'))]
    ...
    def adaptive_instance_normalization(content_feat, style_feat):
        ...
        style_mean, style_std = ImageFolderDataset.calc_mean_std(style_feat)
        content_mean, content_std = ImageFolderDataset.calc_mean_std(content_feat)
