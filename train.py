...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default=r'C:\Users\goodb\OneDrive\Desktop\NST Code\content_data', help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default=r'C:\Users\goodb\OneDrive\Desktop\NST Code\style_data', help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default=r'C:\Users\goodb\OneDrive\Desktop\NST Code\vgg_normalised.pth', help='Location of pre-trained VGG model')
    ...
    parser.add_argument('--log_interval', type=float, default=1, help='Log interval')
    parser.add_argument('--save_interval', type=float, default=2, help='Save interval')
...
def main():
    ...
    content_transform = ImageFolderDataset.get_transform(args.content_size, args.crop, args.final_size)
    style_transform = ImageFolderDataset.get_transform(args.style_size, args.crop, args.final_size)
    ...
    for epoch in range(args.epochs):
        ...
        for content_batch, style_batch in progress_bar:
            ...
            t = ImageFolderDataset.adaptive_instance_normalization(c_feats[-1], s_feats[-1])
            ...
            for g_f, s_f in zip(g_feats, s_feats):
                g_mean, g_std = ImageFolderDataset.calc_mean_std(g_f)
                s_mean, s_std = ImageFolderDataset.calc_mean_std(s_f)
        ...
        if(epoch+1) % args.save_interval == 0:
            ...
            with torch.no_grad():
                ...
                save_image(output, save_dir / 'output_{epoch+1}.png', nrow=args.batch_size)
